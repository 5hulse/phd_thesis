...
# Last Edited: Fri 30 Jun 2023 16:10:13 BST
...
class Widths:
    def __init__(self, p1, p19, p30, delta, d1, d16, acqu):
        total = (
            6 * p1 +
            2 * p19 +
            6 * p30 +
...
widths = Widths(0.1, 0.3, 0.3, 7., 1., 1., 3.)
...
left += widths.p1
sin(axs[1], left, widths.p30, GP1 * (1 - ALPHA), "$g_1(1 - \\alpha)$")
left += widths.p30
delay(axs, "$d_{16}$", left, widths.d16)
left += widths.d16
rect(axs[0], left, 2 * widths.p1, HARD_PULSE_HEIGHT, "$\\pi$ ($\\Phi_2$)")
left += 2 * widths.p1
sin(axs[1], left, widths.p30, -GP1 * (1 + ALPHA), "$-g_1(1 + \\alpha)$")
left += widths.p30
delay(axs, "$d_{16}$", left, widths.d16)
...
rect(axs[0], left, widths.p1, HARD_PULSE_HEIGHT, "$\\nicefrac{\\pi}{2}$ ($\\Phi_3$)")
left += widths.p1
sin(axs[1], left, widths.p30, 2 * ALPHA, "$2 \\alpha g_1$")
left += widths.p30
delay(axs, "$d_{16}$", left, widths.d16)
left += widths.d16
sin(axs[1], left, widths.p19, GP2, "$g_2$")
...
delay(axs, "$d_{16}$", left, widths.d16)
left += widths.d16
rect(axs[0], left, 2 * widths.p1, HARD_PULSE_HEIGHT, "$\\pi$ ($\\Phi_5$)")
left += 2 * widths.p1
sin(axs[1], left, widths.p30, -GP1 * (1 + ALPHA), "$-g_1(1 + \\alpha)$")
left += widths.p30
delay(axs, "$d_{16}$", left, widths.d16)
...
left = widths.d1 + widths.p19 + widths.d16 + widths.p1
difftime = widths.delta + 4 * widths.p1 + 4 * widths.p30 + 5 * widths.d16 + widths.p19
axs[0].text(
...
fig.savefig("figures/oneshot_dosy_pulse_sequence/oneshot_dosy_pulse_sequence.pdf")
