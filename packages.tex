...
\usepackage{datetime}
\dmyyyydate
\usepackage{soul}  % Breakable underlines
...
% To highlight addititions to satisfy minor corrections, set this color to red.
% For the final copy, set this to black
\definecolor{CorrectionColor}{RGB}{255,0,0}
