...
\begin{document}
    ...
    \begin{itemize}
        \item I have made some stylistic changes to the thesis, including the
            ...
            formatting guidelines: I haven't been able to find any specific
    ...
    have been highlighted in ed.
    \begin{itemize}
        \item \cpagerefrange{sec:lof}{sec:loc} -- Tweaked articles of
        ...
        \item \cpageref{corr:high-temp} -- Tweaked the description of he high
            temperature approximation.
        \item \cpageref{corr:rf-pulse} --  Corrected the description of a
        ...
        \item \cpageref{fn:awgn} -- Added \cref{fn:awgn} to state that whenever
        ...
        \item \cpageref{corr:ve-edit} -- Realised that some of the maths
        ...
        \item \cpageref{corr:onedim-timings} -- Mentioned that timings for 1D
            estimation are available in the new \cref{tab:onedim-metrics}
            (\cpageref{tab:onedim-metrics}).
        ...
        \item \cpageref{corr:T2-issues} -- Discussed issues with chemical shift
            evolution if na\"ive \ang{90} -- delay -- detect experiment were
            used for $T_2$ determination.
        \item \cpageref{corr:diffusion-time} -- Corrected the definition for
       ...
       \item \cpageref{corr:stej-tann} -- ``It is virtually always the case
        ...
        \item \cpageref{corr:opt-con-pulses} -- Added references to optimal
            control pulses for broadband excitation.
        \item \cpageref{corr:ninty-flip} -- \cref{fig:single-chirp}: Explicitly
            stated that the flip angle of the chirp pulse is \ang{90} in the
            caption.
        \item \cpageref{corr:baseline-dist} -- \cref{fig:bbqchili-sim}: Made
            explicit reference to baseline distortions in panel b.
        \item \cpageref{corr:bbq-limitations} -- Included a discussion of how
            J-couplings may influence the efficacy of the method.
        \item \cpageref{corr:gd-h2o} -- Improved description of Gd-doped sample.
            See also the caption of \cref{fig:bbqchili-real}.
        \item \cpageref{fig:bbqchili-real} -- \cref{fig:bbqchili-real}:
        ...
        \item \cpageref{fig:j-refocussing} -- \cref{fig:j-refocussing}:
            Corrected scaling of elements in pulse sequence, and removed PFG
            channel.
        \item \cpageref{corr:PSYCHE-2DJ} -- Separated discussions for using
            PSYCHE in a Keeler-Pell-style experiment, and PSYCHE-2DJ.
        \item \cpageref{corr:coupling-constants} -- Clarified that CUPID does not
        ...
        \item \cpageref{fig:estradiol-cupid} -- \cref{fig:estradiol-cupid}: Added
            ...
            the figure.
        \item \cpageref{corr:cupid-steps} -- Enumerated the steps that a user
        ...
        \item \cpageref{corr:concurrency} -- Added a discussion on how
            ...
            \textsc{NMR-EsPy}.
        \item \cpageref{fig:tse_psyche} -- \cref{fig:tse_psyche}: Removed
