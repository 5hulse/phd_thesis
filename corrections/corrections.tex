...
\begin{document}
    ...
    \begin{itemize}
       ...
       \item \cpageref{corr:t1-t2} -- $T_1 \ll T_2 \rightarrow T_1 \gg T_2$.
        ...
        \item \cpageref{fig:jres-spectrum} -- \cref{fig:jres-spectrum}: \textcolor{red}{TODO:
        ...
        \item \cpageref{fig:estradiol-cupid} -- \cref{fig:estradiol-cupid}: Added
            ...
            the figure.
        \cpageref{corr:concurrency} -- Added a discussion of how
            multiprocessing could be employed to improve NLP efficiency.
    \end{itemize}
\end{document}
