...
for last term, rather than $-$. I have $-$, as this makes  $\tau_0$ larger for
...
\note{Double check sign for quadratic term}
\begin{equation}
...
the construction of \iac{FID} featuring oscillators which are back-propagated,
...
The spectrum after quadratic phase correction, in panel b, exhibits the typical
...
As $\tau_{\text{del}}$ is not a readily known parameter, only second-order
