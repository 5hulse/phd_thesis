...
The spectrum after quadratic phase correction, in panel b, exhibits the
...
from a sample of 1\% \ch{Gd}-doped \ch{H2O} in \ch{D2O}\footnote{
    The paramagnetic species \ch{Gd^{III}} is a popular example of a
...
each comprising a single \ch{H2O} signal with differing frequencies.
