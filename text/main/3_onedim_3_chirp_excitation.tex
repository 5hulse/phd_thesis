...
\correction{
    ...
    excitation and inversion, albeit across narrower bandwidths, including
    \ac{BEBOP}~\cite{Skinner2004,Kobzar2012}.
...
\correction{
    ...
    \cref{sec:filtering}. The efficacy of the filtering for this type of data
    may not be sub-optimal, as slowly decaying peaks with dispersion character
    will be feature.
