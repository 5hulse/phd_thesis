...
\begin{table}
    \begin{center}
        \begin{tabular}{ccccccc}
            ...
            $\frac{4 \tau^2 n^2}{T_2^3}\exp\left(-\frac{2 \tau n}{T_2}\right)$ \\
            Diffusion &
            $g$ &
            $D$ &
       ...
       ]
       {
           ...
           \note{Work out derivatives for CPMG. They are currently wrong!}
       }
...
\note{Include result using TopSpin? Get similar value if i set \texttt{sigma}
to 1 (it is 0.9)}
