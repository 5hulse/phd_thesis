...
\acfi{FT}. The \ac{FT} converts a continuous function over time $t$, $x(t)$, to
...
specified function, often called a \emph{window function}\cite[\S
...
(\emph{phase cycling}) enables this\cite[\S 11]{Keeler2010}.
