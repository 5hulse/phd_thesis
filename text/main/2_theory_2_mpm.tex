\section[Matrix Pencil Methods]{Matrix Pencil Methods\footnote{
        \correction{
            ...
            most applications, the matrices involved are assumed to be square
...
\begin{subequations}
   ...
   \end{gather}%
    \label{eq:HX-decomp}%
\end{subequations}%
The matrix pencil $\Hxtwo - \lambda\Hxone$, with $\lambda \in
...
\begin{figure}
    ...
    \caption[
        ...
        signal poles in the indirect dimension.
    ]{
        A comparison of the structure of the matrix $\symbf{G}$ from the
