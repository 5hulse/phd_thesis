...
\note{
    \begin{itemize}
        \item MDL/AIC based on covariance matrix of data. Akin to singular
            values of Hankel matrix.
        \item Basic premise is to determine the point at which singular values
            associated with matrix are no longer decreasing at a considerable
            rate: premise that singular values of noise components should be
            relatively constant and smaller than signal components.
    \end{itemize}
}
