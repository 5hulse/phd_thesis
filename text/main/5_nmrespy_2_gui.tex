...
formats (Figures \ref{fig:gui}.a2 and \ref{fig:gui}.b2).
...
\begin{itemize}
    ...
    \item The regions of interest and the noise region are
        ...
        regions interest are denoted by various colours, while the noise region
        is grey.
...
parameter estimate (e.g. the pure shift spectrum and individual multiplets
structures produced by \ac{CUPID}).
