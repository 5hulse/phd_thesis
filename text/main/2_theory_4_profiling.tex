...
\begin{figure}
    ...
    \caption[
        Outline of the run time and peak memory consumption of
...
a slower rate of increase is observed. The reason for this probably
lies in the implementation of the \ac{SVD} but was not explicitly ascertained.
...
\begin{figure}
    ...
    \caption[
        Outline of the run time and peak memory consumption in
...
function, given by Lines \ref{ln:obj-grad-hess-start} to
\ref{ln:obj-grad-hess-end} in \cref{lst:obj-grad-hess}\footnote{
...
\begin{enumerate}
    ...
    \item Generation of all the non-trivially zero second partial
        ...
        \times N$ array.
    \item Computing the non-zero elements of term \circled{2} in
        \cref{eq:hess}.
    \item Computing term \circled{1} in \cref{eq:hess}.
\end{enumerate}
