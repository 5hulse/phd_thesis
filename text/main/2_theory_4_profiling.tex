...
\begin{itemize}
    ...
    \item Step 2: Generation of all the non-trivially zero second partial
        ...
        \times N$ array.
    \item Step 3: Computing the non-zero elements of term \circled{2} in
        \cref{eq:hess}.
    \item Step 4: Computing term \circled{1} in \cref{eq:hess}.
\end{itemize}
These steps produce an exact Hessian. Neglecting steps 2 \& 3 leads to the
