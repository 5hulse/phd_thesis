...
often, oscillators in the model exhibit ``spurious
...
through appropriate regularisation of the \ac{NLP} routine. Assuming that
...
amplitudes, these are purged, and the routine continues with a reduced number
of oscillators. While not infallible, this can help to purge oscillators in the
