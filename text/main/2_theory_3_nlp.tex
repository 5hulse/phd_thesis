...
estimation is an ``ill-posed problem'',(\note{details/citation?}) such there
...
\cref{subsec:estimation-techniques}). This is also why they are often able to
produce the best results relative to other methods where such information is
not incorporated into the method.
...
results; often, oscillators in the model exhibit \emph{spurious
phases}. As has been discussed (see \cref{subsec:nmr-proc}),
