...
\ac{NMR} spectra from compounds containing nuclei including \ch{^{63}Cu},
\ch{^{65}Cu}, \ch{^{31}P}, \ch{^{14}N}, and \ch{^{19}F} nuclei led to an
...
acquires a net (bulk) magnetic moment $\symbf{M}$, given by the sum of all the
