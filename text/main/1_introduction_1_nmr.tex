...
the unique insights into the structure and dynamics of chemical species that it
can provide.
...
development of the new pulsed \ac{FT} approach.
...
\begin{remark}
    ...
    upper-case bold letters. In this section however, notation
...
such as scalar (J) couplings. However, it provides valuable insights into the
basic principles of \ac{NMR}, including the form that a typical dataset
acquired by an experiment takes.
...
therefore ``invisible'' in the context of \ac{NMR}. Sadly the most abundant
isotopes of two of the most prominent atoms in organic chemistry fall into this
category.
...
sum of all the individual spin moments:
\begin{equation}
...
changing, the current in the ``$Z_0$ coil'' is adjusted to ensure a consistent
field strength is maintained.
...
this reason, cryogenic probes\cite{Kovacs2020} have become a prominent
development, in which the coils and other probe electronics are maintained at a
very low temperature (typically about $\qty{20}{\kelvin}$).
