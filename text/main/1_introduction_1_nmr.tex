...
respectively. The corresponding times (inverse rates) are often referred to as
instead:
$T_1 \coloneq \nicefrac{1}{R_1}$, and
$T_2 \coloneq \nicefrac{1}{R_2}$.
\begin{figure}
...
information to determine whether a given component in \ac{FID} has a frequency
...
generate both the cosine and sine forms, as this ensures that spectra with
