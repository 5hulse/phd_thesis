...
protons and/or neutrons} called \textit{spin}
which, along with orbital angular momentum \correction{and molecular rotation, is one of
the sources} of angular momentum in quantum mechanics.
...
values (i.e. it is quantised). A nucleus \correction{with spin} has an associated
...
\correction{do not possess spin}
