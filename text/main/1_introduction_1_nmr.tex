...
\begin{equation}
  ...
  \label{eq:Iz}
\end{equation}
with $m \in \lbrace -I, -I+1, \cdots, I - 1, I \rbrace$. \cref{eq:I-squared,eq:Iz}
...
\end{equation}
\Cref{fig:energy_levels} illustrates how the relative energies of different
...
a1--d1 in Figure \cref{fig:amp-phase-freq-damp}.
\begin{figure}
    \centering
