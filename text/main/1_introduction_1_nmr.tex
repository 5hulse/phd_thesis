...
exhibit, it is commonplace to express it using a logarithmic scale instead,
using decibels (\unit{\deci\bel}):
\begin{equation}
    \begin{split}
        \SNR_{\unit{\deci\bel}} &\coloneq 10 \log_{10} \left(\SNR\right).
    \end{split}
\end{equation}
From this, the noise variance associated with a signal is
\begin{equation}
