# jres_shifts_and_couplings.py
# Simon Hulse
# simon.hulse@chem.ox.ac.uk
# Last Edited: Mon 26 Jun 2023 19:13:01 BST
...
# SUCROSE CUPID
sucrose_shifts = pickle_load(RESULT_DIR/ "sucrose/shifts.pkl")
sucrose_couplings = get_coupling_info(pickle_load(RESULT_DIR/ "sucrose/couplings.pkl"))
sucrose_tabular = (
    "\\hline\n"
...
four_mp_tabular = get_info_from_file(
    RESULT_DIR / "four_multiplets/shifts_and_couplings.txt",
    "Four Multiplets",
)
table = table.replace("<FOUR-MP>", four_mp_tabular)

with open("text/generated/cupid_shifts_and_couplings.tex", "w") as fh:
    fh.write(table)
