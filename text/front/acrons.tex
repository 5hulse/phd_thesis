\begin{acronyms}
    \begin{acronym}\itemsep=-19pt
        \acro{1D}{one-dimensional}
        \acro{2D}{two-dimensional}
        \acro{2DJ}{two-dimensional J-resolved}
        ...
        \acro{BEBOP}{broadband excitation by optimised pulses}
        ...
        \acro{CONTIN}{continuous distributions of exponentials}
        \acro{CORE}{component resolution}
        ...
        \acro{DECRA}{direct exponential curve resolution algorithm}
        ...
        \acro{FDM}{filter diagonalisation method}
        \acro{FFT}{fast Fourier transform}
        \acroindefinite{FFT}{an}{a}
        \acro{FS}{frequency-swept}
        \acroindefinite{FS}{an}{a}
        \acro{FT}{Fourier transform}
        \acroindefinite{FT}{an}{a}
        \acro{GN}{Gauss-Newton}
        \acro{GNAT}{general NMR analysis toolbox}
        ...
        \acro{EsPy}[\textsc{NMR-EsPy}]{NMR estimation in \textsc{Python}}
        ...
        \acro{PROJECT}{periodic refocusing of J-evolution by coherence transfer}
        \acro{PSYCHE}{pure shift yielded by chirp excitation}
        \acro{PyPI}[\textsc{PyPI}]{\textsc{Python} Package Index}
        \acro{RAM}{random access memory}
        \acro{RF}{radio-frequency}
        \acro{RSS}{residual sum-of-squares}
        \acroindefinite{RSS}{an}{a}
        \acro{SCORE}{speedy component resolution}
        \acro{SI}{Syst\`eme International}
        \acro{SNR}{signal-to-noise ratio}
        \acroindefinite{SNR}{an}{a}
        \acro{SPLMOD}{spline model}
