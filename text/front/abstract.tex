\begin{abstract}
    ...
    As an alternative, parametric estimation techniques aim to provide a
    detailed understanding about each individual signal present in the data.
    ...
    accurate and reliable predictions of the parameters which describe
    \iac{FID}'s constituent signals.
