...
%%% Arrays
\nomenclature[E,01]{$\symbf{x}$, $\symbf{X}$}{
Vectors are denoted with bold lower-case letters. Matrices and
...
\nomenclature[E,05]{$\symbf{X}^{\circlearrowright (d)}$}{Right circular rotation by along axis $d$ of an array by one element.
