...
\nomenclature[B,09]{$\lbrace x, \cdots, y \rbrace$}{The set of consecutive
integers from $x \in \mathbb{Z}$ to $y \in \mathbb{Z}$ (included)}
\nomenclature[B,10]{$(x, y)$}{The range of numbers from $x \in \mathbb{R}$ to $y \in \mathbb{R}$ (excluded)}
\nomenclature[B,11]{$[x, y]$}{The range of numbers from $x \in \mathbb{R}$ to
$y \in \mathbb{R}$ (included).}
\nomenclature[B,12]{$(x, y]$}{The range of numbers from $x \in \mathbb{R}$
...
\nomenclature[D,11]{$\symbf{x}[a:b]$}{
    ...
    \lbrace 0, \cdots, N \rbrace$, and $b \in \lbrace 0, \cdots, N \rbrace$,
